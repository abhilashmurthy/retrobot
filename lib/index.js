...
function setup(callback) {
  ...
  redisClient.getAsync('retrospective').then((retroStr) => {
    console.log('GET RETROSPECTIVE: ' + retroStr);
    retrospective = JSON.parse(retroStr) || {};
  });
}
...
function captureRetrospective(message) {
  ...
  console.log('SET RETROSPECTIVE TO: ' + JSON.stringify(retrospective));
  redisClient.multi().set('retrospective', JSON.stringify(retrospective)).execAsync();
}
